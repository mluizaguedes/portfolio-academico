...
Durante a faculdade, tenho me dedicado à área de desenvolvimento web, com foco em linguagens como JavaScript e TypeScript e tecnologias como React. Também tenho tido contato com banco de dados relacionais e não relacionais, como MySQL e MongoDB, e com recursos de infraestrutura, como AWS e Linux. Mais recentemente, tive a oportunidade de trabalhar com Inteligência Artificial, utilizando o Google ADK e aplicando conceitos modernos de integração e uso de agentes inteligentes.
